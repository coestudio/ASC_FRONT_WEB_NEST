...
export const ShapeCnpj = z
  ...
  .refine(isValidDocument, { message: "CPF ou CNPJ inválido" });
export const ShapeCnpjFormat = z
  .string()
  .nonempty("CNPJ é obrigatório")
...
export const ShapeDocument = z
  ...
  .refine(isValidDocument, { message: "CPF ou CNPJ inválido" });
export const ShapeDocumentFormat = z
  .string()
  .nonempty("Documento é obrigatório")
