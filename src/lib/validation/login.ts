 ...
 *
 * O login em si ainda não está implementado (camada de auth do TanStack
 * Start pendente) — isso só garante que o formato exigido no input já bate
 * com o que o backend vai exigir quando o login passar a chamar o Core.
 */
