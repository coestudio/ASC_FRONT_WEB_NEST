...
// Layout do segmento /operational (Home, Operações). Filho de
// /_dashboard/_internal, que já garante "usuário Internal" (guard
// guarda-chuva) — aqui checa especificamente a área "operacional" (achado
// R1 da SPEC-22: antes só _internal.tsx existia e testava "laboratorio"
// pras três sub-áreas juntas).
export const Route = createFileRoute("/_dashboard/_internal/operational")({
  beforeLoad: async ({ context }) => {
    ...
    if (!getUserAreas(user as PermissionUser | null).includes("operacional")) {
