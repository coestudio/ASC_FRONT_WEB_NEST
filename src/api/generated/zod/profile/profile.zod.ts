...
export const getApiProfileGendersResponseValueRegExpTwo = new RegExp('^-?(?:0|[1-9]\\d*)$');


export const GetApiProfileGendersResponseItem = zod.object({
  "value": zod.union([zod.int(),zod.stringFormat('int32', getApiProfileGendersResponseValueRegExpTwo)]),
  "key": zod.string(),
  "name": zod.record(zod.string(), zod.string())
})
export const GetApiProfileGendersResponse = zod.array(GetApiProfileGendersResponseItem)

export const GetApiProfileGendersValueParams = zod.object({
  "value": zod.int()
})

export const getApiProfileGendersValueResponseValueRegExpTwo = new RegExp('^-?(?:0|[1-9]\\d*)$');


export const GetApiProfileGendersValueResponse = zod.object({
  "value": zod.union([zod.int(),zod.stringFormat('int32', getApiProfileGendersValueResponseValueRegExpTwo)]),
  "key": zod.string(),
  "name": zod.record(zod.string(), zod.string())
})
