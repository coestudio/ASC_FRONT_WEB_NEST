...
export const getApiContainerOperationStatusesResponseValueRegExpTwo = new RegExp(
  "^-?(?:0|[1-9]\\d*)$",
);
...
export const GetApiContainerOperationStatusesResponseItem = zod.object({
  value: zod.union([
    zod.int(),
    zod.stringFormat("int32", getApiContainerOperationStatusesResponseValueRegExpTwo),
  ]),
  key: zod.string(),
  name: zod.record(zod.string(), zod.string()),
});
export const GetApiContainerOperationStatusesResponse = zod.array(
  GetApiContainerOperationStatusesResponseItem,
);
...
export const getApiContainerOperationStatusesValueResponseValueRegExpTwo = new RegExp(
  "^-?(?:0|[1-9]\\d*)$",
);
...
export const GetApiContainerOperationStatusesValueResponse = zod.object({
  value: zod.union([
    zod.int(),
    zod.stringFormat("int32", getApiContainerOperationStatusesValueResponseValueRegExpTwo),
  ]),
  key: zod.string(),
  name: zod.record(zod.string(), zod.string()),
});
...
export const GetApiContainerSealsResponseItem = zod.object({
  value: zod.union([
    zod.int(),
    zod.stringFormat("int32", getApiContainerSealsResponseValueRegExpTwo),
  ]),
  key: zod.string(),
  name: zod.record(zod.string(), zod.string()),
});
...
export const GetApiContainerSealsValueResponse = zod.object({
  value: zod.union([
    zod.int(),
    zod.stringFormat("int32", getApiContainerSealsValueResponseValueRegExpTwo),
  ]),
  key: zod.string(),
  name: zod.record(zod.string(), zod.string()),
});
