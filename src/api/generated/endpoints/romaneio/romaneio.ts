...
export const getApiRomaneioSources = (signal?: AbortSignal) => {
  return apiRequest<EnumOptionDTO[]>({ url: `/api/romaneio/sources`, method: "GET", signal });
};

export const getGetApiRomaneioSourcesQueryKey = () => {
  return [`/api/romaneio/sources`] as const;
};

export const getGetApiRomaneioSourcesQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiRomaneioSources>>,
  TError = void,
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof getApiRomaneioSources>>, TError, TData>
  >;
}) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiRomaneioSources>>> = ({ signal }) =>
    getApiRomaneioSources(signal);
...
export type GetApiRomaneioSourcesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiRomaneioSources>>
>;
export type GetApiRomaneioSourcesQueryError = void;

export function useGetApiRomaneioSources<
  TData = Awaited<ReturnType<typeof getApiRomaneioSources>>,
  TError = void,
>(
  options: {
...
export const getApiRomaneioSourcesValue = (value: number, signal?: AbortSignal) => {
  return apiRequest<EnumOptionDTO>({
    url: `/api/romaneio/sources/${value}`,
    method: "GET",
    signal,
  });
};
...
export const getGetApiRomaneioSourcesValueQueryKey = (value: number) => {
  return [`/api/romaneio/sources/${value}`] as const;
};

export const getGetApiRomaneioSourcesValueQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>,
  TError = void,
>(
  value: number,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>, TError, TData>
    >;
  },
) => {
  const { query: queryOptions } = options ?? {};
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>> = ({
    signal,
  }) => getApiRomaneioSourcesValue(value, signal);
  ...
  return {
    ...
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>, TError, TData> & {
    queryKey: DataTag<QueryKey, TData, TError>;
  };
};

export type GetApiRomaneioSourcesValueQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>
>;
export type GetApiRomaneioSourcesValueQueryError = void;

export function useGetApiRomaneioSourcesValue<
  TData = Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>,
  TError = void,
>(
  value: number,
