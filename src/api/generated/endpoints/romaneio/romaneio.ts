...
export const getApiRomaneioSources = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/romaneio/sources`, method: 'GET', signal
    },
      );
    }
...
export const getGetApiRomaneioSourcesQueryKey = () => {
    return [
    `/api/romaneio/sources`
    ] as const;
    }


export const getGetApiRomaneioSourcesQueryOptions = <TData = Awaited<ReturnType<typeof getApiRomaneioSources>>, TError = void>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiRomaneioSources>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetApiRomaneioSourcesQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiRomaneioSources>>> = ({ signal }) => getApiRomaneioSources(signal);





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiRomaneioSources>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiRomaneioSourcesQueryResult = NonNullable<Awaited<ReturnType<typeof getApiRomaneioSources>>>
export type GetApiRomaneioSourcesQueryError = void


export function useGetApiRomaneioSources<TData = Awaited<ReturnType<typeof getApiRomaneioSources>>, TError = void>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiRomaneioSources>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiRomaneioSources>>,
          TError,
          Awaited<ReturnType<typeof getApiRomaneioSources>>
        > , 'initialData'
      >, }
...
export function useGetApiRomaneioSources<TData = Awaited<ReturnType<typeof getApiRomaneioSources>>, TError = void>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiRomaneioSources>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useGetApiRomaneioSources<TData = Awaited<ReturnType<typeof getApiRomaneioSources>>, TError = void>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getGetApiRomaneioSourcesQueryOptions(options)
...
export const getApiRomaneioSourcesValue = (
    value: number,
 signal?: AbortSignal
) => {
      ...
      return apiRequest<EnumOptionDTO>(
      {url: `/api/romaneio/sources/${value}`, method: 'GET', signal
    },
      );
    }
...
export const getGetApiRomaneioSourcesValueQueryKey = (value: number,) => {
    return [
    `/api/romaneio/sources/${value}`
    ] as const;
    }


export const getGetApiRomaneioSourcesValueQueryOptions = <TData = Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>, TError = void>(value: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetApiRomaneioSourcesValueQueryKey(value);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>> = ({ signal }) => getApiRomaneioSourcesValue(value, signal);





   return  { queryKey, queryFn, enabled: value !== null && value !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiRomaneioSourcesValueQueryResult = NonNullable<Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>>
export type GetApiRomaneioSourcesValueQueryError = void


export function useGetApiRomaneioSourcesValue<TData = Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>, TError = void>(
 value: number, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>,
          TError,
          Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>
        > , 'initialData'
      >, }
...
export function useGetApiRomaneioSourcesValue<TData = Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>, TError = void>(
 value: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiRomaneioSourcesValue>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
