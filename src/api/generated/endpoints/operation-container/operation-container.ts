...
export const getApiContainerOperationStatuses = (signal?: AbortSignal) => {
  return apiRequest<EnumOptionDTO[]>({
    url: `/api/container/operation-statuses`,
    method: "GET",
    signal,
  });
};
...
export const getGetApiContainerOperationStatusesQueryKey = () => {
  return [`/api/container/operation-statuses`] as const;
};

export const getGetApiContainerOperationStatusesQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiContainerOperationStatuses>>,
  TError = void,
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof getApiContainerOperationStatuses>>, TError, TData>
  >;
}) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiContainerOperationStatuses>>> = ({
    signal,
  }) => getApiContainerOperationStatuses(signal);
...
export type GetApiContainerOperationStatusesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiContainerOperationStatuses>>
>;
export type GetApiContainerOperationStatusesQueryError = void;

export function useGetApiContainerOperationStatuses<
  TData = Awaited<ReturnType<typeof getApiContainerOperationStatuses>>,
  TError = void,
>(
  options: {
...
export const getApiContainerOperationStatusesValue = (value: number, signal?: AbortSignal) => {
  return apiRequest<EnumOptionDTO>({
    url: `/api/container/operation-statuses/${value}`,
    method: "GET",
    signal,
  });
};
...
export const getGetApiContainerOperationStatusesValueQueryKey = (value: number) => {
  return [`/api/container/operation-statuses/${value}`] as const;
};

export const getGetApiContainerOperationStatusesValueQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiContainerOperationStatusesValue>>,
  TError = void,
>(
  value: number,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetApiContainerOperationStatusesValueQueryKey(value);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getApiContainerOperationStatusesValue>>
  > = ({ signal }) => getApiContainerOperationStatusesValue(value, signal);
...
export type GetApiContainerOperationStatusesValueQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiContainerOperationStatusesValue>>
>;
export type GetApiContainerOperationStatusesValueQueryError = void;

export function useGetApiContainerOperationStatusesValue<
  TData = Awaited<ReturnType<typeof getApiContainerOperationStatusesValue>>,
  TError = void,
>(
  value: number,
...
export const getApiContainerSeals = (signal?: AbortSignal) => {
  return apiRequest<EnumOptionDTO[]>({ url: `/api/container/seals`, method: "GET", signal });
};

export const getGetApiContainerSealsQueryKey = () => {
  return [`/api/container/seals`] as const;
};

export const getGetApiContainerSealsQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiContainerSeals>>,
  TError = void,
>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiContainerSeals>>, TError, TData>>;
}) => {
  const { query: queryOptions } = options ?? {};

  const queryKey = queryOptions?.queryKey ?? getGetApiContainerSealsQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiContainerSeals>>> = ({ signal }) =>
    getApiContainerSeals(signal);
...
export type GetApiContainerSealsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiContainerSeals>>
>;
export type GetApiContainerSealsQueryError = void;

export function useGetApiContainerSeals<
  TData = Awaited<ReturnType<typeof getApiContainerSeals>>,
  TError = void,
>(
  options: {
    query: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getApiContainerSeals>>, TError, TData>
    > &
      Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiContainerSeals>>,
...
export const getApiContainerSealsValue = (value: number, signal?: AbortSignal) => {
  return apiRequest<EnumOptionDTO>({ url: `/api/container/seals/${value}`, method: "GET", signal });
};

export const getGetApiContainerSealsValueQueryKey = (value: number) => {
  return [`/api/container/seals/${value}`] as const;
};

export const getGetApiContainerSealsValueQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiContainerSealsValue>>,
  TError = void,
>(
  value: number,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getApiContainerSealsValue>>, TError, TData>
    >;
  },
) => {
  const { query: queryOptions } = options ?? {};
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiContainerSealsValue>>> = ({
    signal,
  }) => getApiContainerSealsValue(value, signal);
  ...
  return {
    ...
    enabled: value !== null && value !== undefined,
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof getApiContainerSealsValue>>, TError, TData> & {
    queryKey: DataTag<QueryKey, TData, TError>;
  };
};

export type GetApiContainerSealsValueQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiContainerSealsValue>>
>;
export type GetApiContainerSealsValueQueryError = void;

export function useGetApiContainerSealsValue<
  TData = Awaited<ReturnType<typeof getApiContainerSealsValue>>,
  TError = void,
>(
  value: number,
